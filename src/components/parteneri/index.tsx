 ...
 const Parteneri = ({titlu, indemn, logoParteneri}:{titlu:string, indemn:string, logoParteneri:any}) => {
  return (
    <section id="list" className={tw(`lg:py-28 pt-28 overflow-hidden`)}>
      ...
      <div className={tw('grid grid-cols-3 place-content-center place-items-center gap-4')}>
        ...
        {logoParteneri.map((logo: any) => (
          <div
            ...
            key={logo.url}
            className={tw('self-center place-items-center place-self-center w-2/6 h-4/6')}
          >
